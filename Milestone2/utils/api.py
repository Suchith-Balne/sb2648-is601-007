...
if __name__ == "__main__":
    querystring = {"types":"movie,tv_series","regions":"US","source_types":"sub,free","source_ids":"23,206","page":"1","limit":"250","genres":"4,9","sort_by":"relevance_desc","network_ids":"1,8,12","release_date_start":"20010101","release_date_end":"20201211"}
    
    resp = API.get("/list-titles", querystring)
    print(resp)